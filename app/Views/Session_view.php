  ...
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form action="<?= base_url('iniciarsesion/auth') ?>"  method="post">
          ...
          <label class="form-label" for="form3Example3">Direccion Email</label>
            <input name="correo" id="correo" type="email" id="form3Example3" class="form-control form-control-lg"
              placeholder="Email" />
          </div>
